...
program:
    declarations                                 {puts("reduce1");$$=newast(PROG,$1,NULL);display($1,0);ptree=$$;}
    ;

declarations:
    TYPE var_init_list ';'                       {puts("reduce2");$$=newdec(EXTERN_VAR,$1,$2,NULL);}
...
stmt: exp ';'                                    {puts("reduce24");$$=$1;} 
    ...
    | IF '(' exp ')' stmt ELSE stmt              {puts("reduce30");$$=newcondition(IF_ELSE,$3,$5,$7,NULL);}
...
exp: exp '=' exp                                {puts("reduce40");$$=newast(ASSIGN,$1,$3);}
    ...
    | INT                                       {puts("reduce56");$$=newnum(INT_NO);((struct num*)$$)->numval.intval=$1;}
